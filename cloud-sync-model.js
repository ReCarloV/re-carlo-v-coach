(function(root,factory){const api=factory();if(typeof module!=='undefined'&&module.exports)module.exports=api;if(root)root.rcCloudSyncModel=api;})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  const fieldLabels=Object.freeze({firstName:'nome',lastName:'cognome',birthDate:'data di nascita',heightCm:'altezza',weightKg:'peso',hrMax:'FC massima',restingHr:'FC a riposo',ftp:'FTP',sports:'discipline',equipment:'attrezzatura',personalBests:'personal best',performanceTests:'test e valutazioni',strengthMaxes:'massimali',planView:'vista Piano',uiTheme:'tema'});
