const views = { today: 'Ciao.', workout:'Allenamento di oggi', goals:'Obiettivi e gare', plan: 'Piano adattivo', recap:'Recap settimanale', profile: 'Il tuo profilo atleta', data:'Impostazioni' };
