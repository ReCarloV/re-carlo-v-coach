(function(root,factory){
  ...
  function buildSessions(){
    const templates=[
      ...
      ['lower-06','2026-06-06','strength','Lower strength',55,'important',strengthDetails('Lower body',[{name:'Back Squat',sets:'4',reps:'5',target:'105 kg',rest:'2 min'},{name:'Trap Bar Deadlift',sets:'3',reps:'5',target:'125 kg',rest:'2 min'}],3),{duration:55,rpe:7,strengthPerformance:[{exercise:'Back Squat',loadKg:105,reps:5},{exercise:'Trap Bar Deadlift',loadKg:125,reps:5}]}],
      ...
      ['lower-15','2026-06-15','strength','Lower strength',60,'important',strengthDetails('Lower body',[{name:'Front Squat',sets:'4',reps:'4',target:'90 kg',rest:'2 min'},{name:'Bulgarian Split Squat',sets:'3',reps:'8',target:'24 kg',rest:'90 s'}],2),{duration:61,rpe:8,execution:'harder',pain:2,strengthPerformance:[{exercise:'Front Squat',loadKg:90,reps:4}]}],
